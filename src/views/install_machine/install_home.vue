            ...
            <el-col class="well well-lg" style="background-color: white;" >
	            ...
	            <el-dialog title="安装项选择" :visible.sync="showInstallDialog" append-to-body >
                    <el-form label-position="right" label-width="90px" >
	                    <el-row >
	                        <el-col :span="8" >
	                           <el-select v-model="installLib" clearable >
                                    <el-option
		                                    v-for="item in installLibList"
		                                    :value="item.installLibName"
		                                    :label="item.installLibName" >
                                    </el-option >
	                           </el-select >
	                        </el-col >
	                    </el-row >
    ...
    export default {
	    ...
	    methods: {
		    ...
		    filterInstallInfo(info)
		    {
			    ...
			    if (strInfoList.length > 0) {
				    ...
				    for (let i = 0; i < strInfoList.length; i++) {
					    if (strInfoList[i].install_lib_name != resName) {
						    resName = strInfoList[i].install_lib_name;
						    break;
					    }
				    }
			    }
		    ...
		    editInstall(row)
		    {
			    ...
			    _this.installLib = _this.filterInstallInfo(row.installInfo);
